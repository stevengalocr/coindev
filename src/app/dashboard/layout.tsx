    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: 'var(--bg)' }}>
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 15, fontWeight: 700, letterSpacing: '-0.02em', color: 'var(--text)', lineHeight: 1.2 }}>
              CoinDev
            </div>
            <div style={{ fontSize: 10.5, color: 'var(--text-3)', marginTop: 2, lineHeight: 1 }}>
              {t.tagline}
            </div>
          </div>
        </div>
                ...
                <div key="fab" style={{ display: 'flex', justifyContent: 'center', padding: '0 4px' }}>
                  <button
                    style={{
                      ...
                      placeItems: 'center',
                      color: '#0C0E14',
                      boxShadow: '0 6px 24px rgba(91, 155, 255, 0.45)',
                      marginTop: -22,
                      flexShrink: 0,
                    }}
                    aria-label={t.add}
