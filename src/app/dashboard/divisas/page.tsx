          ...
          <div className="cd-card" style={{ padding: '20px 22px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'stretch', gap: 10 }}>
              ...
              <button
                ...
                style={{
                  width: 42, height: 'auto', borderRadius: 14, flexShrink: 0,
                  background: 'var(--surface-2)', border: '1px solid var(--border)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: 'var(--text-2)', transition: 'background 120ms',
                }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
              ...
              {live && (
                <span style={{
                  ...
                  background: 'var(--income-soft)', borderRadius: 999, padding: '2px 8px', flexShrink: 0,
                }}>
...
function ConverterField({ symbol, code, value, onChange, placeholder, readOnly = false }: {
  ...
  return (
    <div
      style={{
        flex: 1, minWidth: 0,
        background: readOnly ? 'var(--surface)' : 'var(--surface-2)',
        border: '1.5px solid var(--border)',
        borderRadius: 14, padding: '14px 16px',
        transition: 'border-color 150ms', cursor: readOnly ? 'default' : 'text',
      }}
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 3, minWidth: 0 }}>
        <span className="mono" style={{ fontSize: 20, color: 'var(--text-3)', fontWeight: 500, lineHeight: 1, flexShrink: 0 }}>{symbol}</span>
        <input
          value={value}
